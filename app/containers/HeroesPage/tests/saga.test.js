/**
 * Tests for HeroesPage sagas
 */

import { put, takeLatest } from 'redux-saga/effects';

import { LOAD_REPOS } from 'containers/App/constants';
import { reposLoaded, repoLoadingError } from 'containers/App/store/actions';
...
describe('getRepos Saga', () => {
  ...
  beforeEach(() => {
    ...
    const callDescriptor = getReposGenerator.next(Filter).value;
  ...
  it('should dispatch the reposLoaded action if it requests the data successfully', () => {
    ...
    expect(putDescriptor).toEqual(put(reposLoaded(response, Filter)));
  });
